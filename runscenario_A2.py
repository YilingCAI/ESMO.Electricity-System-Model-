...
opt.options['simplex.tolerances.optimality'] = 1e-1
opt.options['simplex.tolerances.feasibility'] = 1e-1
...
for i in range(len(SCE_ARR)):
    ...
    if sce_name == run_name:
        ...
        instance.totalinstalledimporttranscapacity['FR-DE', 2050].fix(6600)
        instance.totalinstalledexporttranscapacity['FR-DE', 2050].fix(6600)
        instance.totalinstalledimporttranscapacity['FR-IT', 2050].fix(3200)
        instance.totalinstalledexporttranscapacity['FR-IT', 2050].fix(5300)
        instance.totalinstalledimporttranscapacity['FR-BE', 2050].fix(4000)
        instance.totalinstalledexporttranscapacity['FR-BE', 2050].fix(5500)
        instance.totalinstalledimporttranscapacity['FR-ES', 2050].fix(8600)
        instance.totalinstalledexporttranscapacity['FR-ES', 2050].fix(8600)
        instance.totalinstalledimporttranscapacity['FR-CH', 2050].fix(2500)
        instance.totalinstalledexporttranscapacity['FR-CH', 2050].fix(4900)
        instance.totalinstalledimporttranscapacity['FR-UK', 2050].fix(7600)
        instance.totalinstalledexporttranscapacity['FR-UK', 2050].fix(7600)
        instance.totalinstalledimporttranscapacity['FR-IE', 2050].fix(1200)
        instance.totalinstalledexporttranscapacity['FR-IE', 2050].fix(1200)
        ...
        for i in range(0, 90000, 10000):
            for j in range(0, 320000, 40000):
                ...
                instance.totalinstalledimporttranscapacity['FR-DE',
                                                           2050].fix(6600)
                instance.totalinstalledexporttranscapacity['FR-DE',
                                                           2050].fix(6600)
                instance.totalinstalledimporttranscapacity['FR-IT',
                                                           2050].fix(3200)
                instance.totalinstalledexporttranscapacity['FR-IT',
                                                           2050].fix(5300)
                instance.totalinstalledimporttranscapacity['FR-BE',
                                                           2050].fix(4000)
                instance.totalinstalledexporttranscapacity['FR-BE',
                                                           2050].fix(5500)
                instance.totalinstalledimporttranscapacity['FR-ES',
                                                           2050].fix(8600)
                instance.totalinstalledexporttranscapacity['FR-ES',
                                                           2050].fix(8600)
                instance.totalinstalledimporttranscapacity['FR-CH',
                                                           2050].fix(2500)
                instance.totalinstalledexporttranscapacity['FR-CH',
                                                           2050].fix(4900)
                instance.totalinstalledimporttranscapacity['FR-UK',
                                                           2050].fix(7600)
                instance.totalinstalledexporttranscapacity['FR-UK',
                                                           2050].fix(7600)
                instance.totalinstalledimporttranscapacity['FR-IE',
                                                           2050].fix(1200)
                instance.totalinstalledexporttranscapacity['FR-IE',
                                                           2050].fix(1200)
